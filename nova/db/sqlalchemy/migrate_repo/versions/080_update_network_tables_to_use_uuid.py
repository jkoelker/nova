...
vifs_network_uuid_column = sa.Column("network_uuid", sa.String(36))
vifs_instance_uuid_column = sa.Column("instance_uuid", sa.String(36))


fixed_ips_uuid_column = sa.Column("uuid", sa.String(36))
fixed_ips_network_uuid_column = sa.Column("network_uuid", sa.String(36))
fixed_ips_vif_uuid_column = sa.Column("virtual_interface_uuid",
                                      sa.String(36))
fixed_ips_instance_uuid_column = sa.Column("instance_uuid", sa.String(36))


floating_ips_uuid_column = sa.Column("uuid", sa.String(36))
floating_ips_fixed_ip_uuid_column = sa.Column("fixed_ip_uuid",
                                               sa.String(36))
...
def upgrade(migrate_engine):
    ...
    vifs.create_column(vifs_network_uuid_column)
    vifs.create_column(vifs_instance_uuid_column)

    fixed_ips.create_column(fixed_ips_uuid_column)
    fixed_ips.create_column(fixed_ips_network_uuid_column)
    fixed_ips.create_column(fixed_ips_vif_uuid_column)
    fixed_ips.create_column(fixed_ips_instance_uuid_column)

    floating_ips.create_column(floating_ips_uuid_column)
    floating_ips.create_column(floating_ips_fixed_ip_uuid_column)
...
def downgrade(migrate_engine):
    ...
    #TODO(jkoelker) fillin ids
    fixed_ips.drop_column(fixed_ips_uuid_column)
    floating_ips.drop_column(floating_ips_uuid_column)

    vifs.drop_column(vifs_network_uuid_column)
    vifs.drop_column(vifs_instance_uuid_column)

    fixed_ips.drop_column(fixed_ips_uuid_column)
    fixed_ips.drop_column(fixed_ips_network_uuid_column)
    fixed_ips.drop_column(fixed_ips_vif_uuid_column)
    fixed_ips.create_column(fixed_ips_instance_uuid_column)

    floating_ips.drop_column(floating_ips_uuid_column)
    floating_ips.drop_column(floating_ips_fixed_ip_uuid_column)
