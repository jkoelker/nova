...
melange_opts = [
    flags.cfg.StrOpt('melange_host',
                     default='127.0.0.1',
                     help='HOST for connecting to melange'),
    flags.cfg.IntOpt('melange_port',
                     default=9898,
                     help='PORT for connecting to melange'),
    flags.cfg.IntOpt('melange_num_retries',
                     default=0,
...
class Connection(object):
    def __init__(self, host=None, port=None, use_ssl=False):
        self.host = host or FLAGS.melange_host
        self.port = port or FLAGS.melange_port
    ...
    # TODO(jkoelker) Convert this to using urllib3 for conenction pooling
    #                and better retry/error support
    def do_request(self, method, path, body=None, headers=None, params=None,
        ...
        for i in xrange(retries + 1):
            ...
            try:
                ...
                msg = _('Server returned error: %s') % response_str
                raise exception.MelangeConnectionFailed(msg)
